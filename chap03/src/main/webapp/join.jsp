...
<%@ include file="./include/header.jsp" %>
    ...
    <main>
		<div class="container">
			...
			<div id="contents">
				<!-- 데이터 받아서 처리// , forward 방식으로 처리 -->
				<form action="join_process.jsp" method="post" id="join" class="form">
				<table>
					<colgroup>
						<col style="width:20%">
						<col style="width:80%">
					...
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="user_name" placeholder="이름를 입력하세요."> </td>
						</tr>
						<tr>
							<th>주소<span class="required">*</span></th>
							<td>
								<div>
									<input type="number" name="user_zipcode" placeholder="우편번호" class="short" id="zipcode">
									<button class="btn btnZipcode ">우편번호</button>
								</div>
								<div class="addrBox">
									<input type="text" name="address01" placeholder="주소" id="address01">
									<span class="sticker">기본 주소</span>
								</div>
								<div class="addrBox">
									<input type="text" name="address02" placeholder="주소" id="address02">
