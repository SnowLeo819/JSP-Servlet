<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<<<<<<< HEAD:member_review_slfe/src/main/webapp/join2.jsp
<%@ include file="./include/header.jsp"  %>
    ...
    <script>
    	...
    	const email = /^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i;//이메일 정규식
...
>>>>>>> 9fdbedca618685e33e789e11fb94cacac1f454e2:jsp-board-dao/src/main/webapp/write.jsp
						...
						<tr>
							...
							<td><textarea id="summernote" placeholder="내용을 입력하세요."
									name="user_contents"></textarea></td>
						</tr>
					</tbody>
				</table>
				<div class="btns">
