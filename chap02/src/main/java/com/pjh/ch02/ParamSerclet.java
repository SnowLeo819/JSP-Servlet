...
public class ParamSerclet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setCharacterEncoding("UTF-8");                // 요청받을 때 .. 그냥 둘다 미리쓰기..  
		response.setContentType("text/html; charset=UTF-8");  // 내보낼 때 
		...
		out.println("당신의 ID는 "+userId+" 이고, 나이는 "+userAge+"세 입니다. 당신은 "+isAdult+"입니다");
